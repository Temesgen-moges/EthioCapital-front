  ...
  useEffect(() => {
    ...
    const fetchApplications = async () => {
      ...
      try {
        ...
        const response = await axios.get("https://ethiocapital-back.onrender.com/api/v1/student-applications", {
    ...
    socketInstance.on("newApplication", (newApp) => {
      ...
      if (
        ...
        axios
          .get(`https://ethiocapital-back.onrender.com/api/v1/student-applications/${newApp.id}`, {
